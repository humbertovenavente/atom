...
- [ ] **Phase 1: Foundation & Setup** - Analog.js scaffold, @foblex/flow, Tailwind, 3-panel layout, types, MongoDB connection
- [ ] **Phase 2: Data & Backend** - Seed MongoDB Atlas con vector embeddings desde jsons/, API routes para vehicles/dates/FAQ, users & sessions
- [ ] **Phase 3: Flow Editor** - Custom nodes, drag & drop, edges, mini-map, zoom, FlowService
...
| 2. Data & Backend | 0/? | Not started | - |
| 3. Flow Editor | 0/? | Not started | - |
